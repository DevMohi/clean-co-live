    ...
    return (
        <div class="drawer drawer-end">
            ...
            <div class="drawer-content flex flex-col">
                {/* <!-- Navbar --> */}
                <div class="w-full navbar fixed top-0 bg-base-100 lg:px-20 z-50">
                    ...
                    <div class="flex-none hidden lg:block">
                        <ul class="menu menu-horizontal gap-x-2">
                            ...
                            <li><NavLink to='/' className='rounded-lg'>Home</NavLink>
                            </li>
                            {admin && <li><NavLink to='/dashboard/add-service' className='rounded-lg'>Dashboard</NavLink>
                            </li>}
                            <li>
                                <NavLink to='/about'
                            ...
                            <li><NavLink to='/login' className='rounded-lg'>Login</NavLink>
                            </li>
                            ...
                            <label data-toggle-theme="dark,light" onClick={themeChange} class="swap swap-rotate">
                                <input type="checkbox" />
